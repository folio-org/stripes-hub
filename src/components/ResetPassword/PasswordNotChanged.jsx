...
import { Headline, OrganizationLogo } from '../../StripesComponents';
...
import styles from './PasswordNotChanged.module.css';
...
class PasswordNotChanged extends Component {
  ...
  defineErrorCode = () => {
    ...
    const labelNamespace = 'stripes-hub.errors';
    ...
    return (
      ...
      >
        <div className={styles.centered}>
          <OrganizationLogo branding={this.props.branding} />
          <Headline
            size="x-large"
            tag="p"
            faded
...
export default PasswordNotChanged;
