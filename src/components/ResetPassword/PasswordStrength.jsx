...
import { Col, InfoPopover, Row, TextField } from '../../StripesComponents';
        ...
        >
          ...
          <div className="password-strength">
            <div className={css['password-strength__label']}>
              <FormattedMessage
                id="stripes-hub.passwordStrength.label"
              />
            </div>
            <div
            ...
            <div className={css['password-strength-text__wrapper']}>
              <FormattedMessage
                id={`stripes-hub.passwordStrength.${output}`}
              />
              <InfoPopover
                content={
                  <FormattedMessage
                    id="stripes-hub.passwordStrength.infoPopoverText"
                  />
                }
              />
            </div>
